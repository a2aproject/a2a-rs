...
The A2A-RS project team welcomes security reports and is committed to
...
users of A2A-RS, and maintainers of upstream dependencies if applicable.

Downstream project maintainers and A2A-RS users can request participation in
...
Participation in security issue coordination processes is at the discretion of the A2A-RS team.
